...
def build_figure_side_by_side(spec, output_dir):
    ...
    axB.imshow(head)
    axB.axis("off")
    axB.text(0.0, 1.0, topo_row.get("letters", ["B"])[0], transform=axB.transAxes,
             fontsize=18, fontweight="bold", va="top", ha="left")
...
FIGURES = [
    {
        "out": "obstacle_PREP_fig1_TFR_topo.png",   # Figure 6 panels A-E
        "rows": [
            # Panel A: the combined TFR with all four cluster outlines.
            {"letter": "A", "kind": "single",
             "images": [r"D:\Cluster_plots_last_prep\all_clusters_tfr\obstacle_main_effect_prep_1000perm_seed42__PREP__ALL_CLUSTERS_TFR.png"]},
            # Panels B-E: four topomaps aligned under the heatmap, with a fresh
            # F-Value colourbar placed directly below the TFR's (same x) and
            # cluster labels sized to match the TFR legend. Order cluster02,03,07,01
            # so Cluster 1-4 match the TFR F-mass ranking.
            {"letters": ["B", "C", "D", "E"], "kind": "topomaps",
             "align_tfr": True, "label_frac": 0.12, "label_gap": 34,
             "cbar": {"cmap": "Reds", "vmin": 0, "vmax": 10, "label": "F-Value"},
             "labels": ["Cluster 1", "Cluster 2", "Cluster 3", "Cluster 4"],
             "images": [r"D:\Cluster_plots_last_prep\cluster_outputs\obstacle_main_effect_prep_1000perm_seed42__PREP__OBSTACLE_MAIN\cluster02_topomap_agg.png",
                        r"D:\Cluster_plots_last_prep\cluster_outputs\obstacle_main_effect_prep_1000perm_seed42__PREP__OBSTACLE_MAIN\cluster03_topomap_agg.png",
                        r"D:\Cluster_plots_last_prep\cluster_outputs\obstacle_main_effect_prep_1000perm_seed42__PREP__OBSTACLE_MAIN\cluster07_topomap_agg.png",
                        r"D:\Cluster_plots_last_prep\cluster_outputs\obstacle_main_effect_prep_1000perm_seed42__PREP__OBSTACLE_MAIN\cluster01_topomap_agg.png"]},
        ],
    },
    {
        "out": "obstacle_RESET_fig1_TFR_topo.png",   # Figure 8 panels A-B
        "layout": "side_by_side",
        "height_in": 4.0, "head_frac": 0.66, "tfr_gap": 0.45,
        "rows": [
            # Panel A: the TFR; its single-cluster legend is cropped off.
            {"letter": "A", "kind": "single", "crop_legend": True,
             "images": [r"D:\Cluster_plots_last_prep\all_clusters_tfr\obstacle_main_effect_reset_1000perm_seed42__RESET__ALL_CLUSTERS_TFR.png"]},
            # Panel B: the single topomap, to the right of the TFR. No cluster
            # label (only one cluster); colourbar font matched to the TFR.
            {"letters": ["B"], "kind": "topomaps",
             "cbar": {"cmap": "Reds", "vmin": 0, "vmax": 10, "label": "F-Value",
                      "label_fontsize": 14, "tick_fontsize": 12},
             "images": [r"D:\Cluster_plots_last_prep\cluster_outputs\obstacle_main_effect_reset_1000perm_seed42__RESET__OBSTACLE_MAIN\cluster00_topomap_agg.png"]},
        ],
    },
]
