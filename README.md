...
Run steps 1 to 5 of the gait pipeline from the [gait_analysis](https://github.com/DanishtaKaul/gait_analysis) repository first to produce the time series these scripts read.
