...
# -*- coding: utf-8 -*-
"""
Figure 7: the light main effect, reset phase.
...
TFR_TOPO_BLOCK = Path(
    r"D:\Cluster_plots_last_prep\composites\light_RESET_fig1_TFR_topo.png")


# The two line-plot pkls, display order (Cluster 1 first).

PKL_CLUSTER1 = Path(
    r"D:\Cluster_plots_last_prep\line_plots\light_post_hoc_RESET\cluster24_ALL_THREE_inputs.pkl")
PKL_CLUSTER2 = Path(
    r"D:\Cluster_plots_last_prep\line_plots\light_post_hoc_RESET\cluster0_ALL_THREE_inputs.pkl")

OUT_PATH = Path(r"D:\Cluster_plots_last_prep\composites\light_RESET_FINAL.png")
